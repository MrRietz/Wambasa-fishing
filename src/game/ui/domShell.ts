        ...
        <section class="rts-command-panel" aria-label="Command panel">
          ...
          <div class="rts-command-grid" aria-label="Context actions">
            <div id="factory-command-panel" class="rts-factory-commands" hidden>
              ...
              <button id="produce-worker-button" data-command-icon="WK" data-command-tone="econ" type="button" aria-label="Build Worker - 80 metal">Build Worker<br><span>80 metal</span></button>
              <button id="produce-truck-button" data-command-icon="TR" data-command-tone="econ" type="button" aria-label="Build Truck - 180 metal">Build Truck<br><span>180 metal</span></button>
            ...
            <div id="barracks-command-panel" class="rts-factory-commands" hidden>
              ...
              <button id="produce-guard-button" data-command-icon="GD" data-command-tone="combat" type="button" aria-label="Build Guard - 120 metal + 20 cash">Build Guard<br><span>120 metal + 20 cash</span></button>
              <button id="produce-saboteur-button" data-command-icon="SB" data-command-tone="combat" type="button" aria-label="Build Saboteur - 150 metal + 40 cash">Build Saboteur<br><span>150 metal + 40 cash</span></button>
            ...
            <div id="dock-command-panel" class="rts-dock-commands" hidden>
              ...
              <button id="produce-boat-button" data-command-icon="FB" data-command-tone="econ" type="button" aria-label="Build Fishing Boat - 140 metal + 40 cash">Build Fishing Boat<br><span>140 metal + 40 cash</span></button>
              <button id="produce-attack-boat-button" data-command-icon="AB" data-command-tone="combat" type="button" aria-label="Build Attack Boat - 180 metal + 80 cash">Build Attack Boat<br><span>180 metal + 80 cash</span></button>
            ...
            <div id="worker-command-panel" class="rts-worker-commands" hidden>
              ...
              <button id="place-house-button" data-command-icon="HS" data-command-tone="build" type="button" aria-label="Build House - 120 metal, +4 crew capacity">Build House<br><span>+4 crew cap</span></button>
              <button id="place-dock-button" data-command-icon="DK" data-command-tone="build" type="button" aria-label="Plan Dock - 160 metal">Plan Dock<br><span>160 metal</span></button>
              <button id="place-guard-tower-button" data-command-icon="GT" data-command-tone="combat" type="button" aria-label="Plan Guard Tower - 220 metal">Plan Guard Tower<br><span>220 metal</span></button>
              <button id="place-tech-lab-button" data-command-icon="TL" data-command-tone="utility" type="button" aria-label="Plan Tech Lab - 260 metal">Plan Tech Lab<br><span>260 metal</span></button>
              <button id="place-barracks-button" data-command-icon="BR" data-command-tone="combat" type="button" aria-label="Plan Barracks - 240 metal">Plan Barracks<br><span>240 metal</span></button>
